        ...
        <div className="profil-container">
            ...
            <div className="update-container">
                ...
                <div className="right-part">
                    ...
                    {/* si tu as déjà la data userData.following alors tu l'affiche sinon tu n'affiche rien*/}
                                    ...
                                    if (user._id===userData.following[i]){
                                        return (
                                            <li key={user._id}>
                                                ...
                                                {/* Appel FollowHandler en lui passant en argument la data user._id */}
